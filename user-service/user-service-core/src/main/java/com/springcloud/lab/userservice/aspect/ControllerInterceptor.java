package com.springcloud.lab.userservice.aspect;
...
public class ControllerInterceptor {
    ...
    @Pointcut("execution(* com.springcloud.lab.userservice.controller.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
